  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // 🔧 Removido o `sm:max-w-lg` que limitava o tamanho do modal
          // Agora só existe esse `max-w-[calc(100%-2rem)]`,
          // que pode ser sobrescrito pelo `className` passado em cada uso.
